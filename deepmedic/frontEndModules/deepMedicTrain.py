...
from deepmedic.frontEndModules.frontEndHelpers.preparationForSessionHelpers import \
    makeFoldersNeededForTrainingSession
from deepmedic.frontEndModules.frontEndHelpers.trainParametersClass import \
...
def deepMedicTrainMain(trainConfigFilepath, absPathToSavedModelFromCmdLine,
    ...
    sessionName = configGet(trainConfig.SESSION_NAME) if configGet(
        trainConfig.
        SESSION_NAME) else TrainSessionParameters.getDefaultSessionName()
    ...
    if configGet(trainConfig.CHANNELS_TR):
        ...
        listOfAListPerChannelWithFilepathsOfAllCasesTrain = [
            parseAbsFileLinesInList(getAbsPathEvenIfRelativeIsGiven(
                channelConfPath, trainConfigFilepath))
    ...
    gtLabelsFilepathsTrain = parseAbsFileLinesInList(
        getAbsPathEvenIfRelativeIsGiven(
            configGet(
                trainConfig.GT_LABELS_TR), trainConfigFilepath)) if configGet(
                    trainConfig.GT_LABELS_TR) else None
    roiMasksFilepathsTrain = parseAbsFileLinesInList(
        getAbsPathEvenIfRelativeIsGiven(
            configGet(
                trainConfig.ROI_MASKS_TR), trainConfigFilepath)) if configGet(
    ...
    if configGet(trainConfig.WEIGHT_MAPS_PER_CAT_FILEPATHS_TR):
        ...
        listOfAListPerWeightMapCategoryWithFilepathsOfAllCasesTrain = [
            parseAbsFileLinesInList(getAbsPathEvenIfRelativeIsGiven(
                weightMapConfPath, trainConfigFilepath))
